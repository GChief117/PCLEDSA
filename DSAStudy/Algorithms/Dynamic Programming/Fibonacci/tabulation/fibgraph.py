...
# Insert directories and files into a graph while calculating Fibonacci using tabulation
def insert_in_graph_fib_tab(root_directory):
    graph = Graph()
    ...
    for dirpath, dirnames, filenames in os.walk(root_directory):
        ...
        for dirname in dirnames:
            ...
            fib_result = fibonacci_tab(len(subdir_path))
...
# Example usage for the graph with tabulation
