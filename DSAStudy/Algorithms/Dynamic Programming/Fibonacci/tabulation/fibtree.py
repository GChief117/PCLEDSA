...
# Insert directories and files into a regular tree while calculating Fibonacci using tabulation
def insert_in_tree_fib_tab(root_directory):
    tree = Tree()
    parent_map = {}
...
# Example usage for the regular tree with tabulation
